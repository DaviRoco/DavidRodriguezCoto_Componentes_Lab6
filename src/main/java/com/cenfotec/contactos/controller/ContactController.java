...
//          @RestController es mejor usarlo cuando se requiere de la metodología REST mientras que @Controller
//    c. Por qué en el findAll no se especifica el URI para la operación?
//        En findAll no se especifica el URL para la operación porque en el service se hace el findAll, se trae una lista de Contact.
